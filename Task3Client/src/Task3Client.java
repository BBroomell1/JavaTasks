...
public class Task3Client {
	...
	public static void main(String[] args) {
		...
		// Check if port number was passed correctly as a parameter to client application.
		if(args.length != 1)
		{
		...
		try
		{
			...
			System.out.println("Server Says: " + inputStream.toString());
			/*	This uses Readers/Writers	
